...
// Call the getQuantites() method on the instance of Stock
    ...
    private void Categorieequipement(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("../gui/CategorieIndex.fxml"));
    ...
    private void stockac(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("../gui/Details.fxml"));
            labelIndex.getScene().setRoot(loader.load());
    ...
    private void StockAdd(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("../gui/AjoutStock.fxml"));
            labelIndex.getScene().setRoot(loader.load());
    ...
    private void StockUpdate(ActionEvent event) throws SQLException {
        ...
        if (e != null) {
            ...
            try {
                FXMLLoader loader;
                loader = new FXMLLoader(getClass().getResource("../gui/EditStock.fxml"));
