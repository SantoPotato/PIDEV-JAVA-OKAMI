 ...
 * @author USER
 */
public class DetailsVehiculesController implements Initializable {
...
private void StockSearch(ActionEvent event) {
 ...
 @FXML
    private void stockac(ActionEvent event) {
         try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("AjoutVehicules.fxml"));
            labelIndex.getScene().setRoot(loader.load());
    ...
    private void StockUpdate(ActionEvent event) throws SQLException {
        ...
        if (e != null) {
           // System.out.println("aaaaaaaaaaaaa");
            ...
            try {
                FXMLLoader loader;
                loader = new FXMLLoader(getClass().getResource("Editvehicules.fxml"));
...
if (p.isDispovh() == 1) {
 ...
 @FXML
    private void btnstat(ActionEvent event) {
        try {
        Parent reclamationsParent = FXMLLoader.load(getClass().getResource("statvehicule.fxml"));
    ...
    private void Btnfront(ActionEvent event) {
         try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("frontvehicules.fxml"));
            labelIndex.getScene().setRoot(loader.load());
